...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # Certifique-se de que o middleware do CORS vem logo após o SecurityMiddleware
...
# Permitir que o Django inclua o cabeçalho 'Access-Control-Allow-Origin'
